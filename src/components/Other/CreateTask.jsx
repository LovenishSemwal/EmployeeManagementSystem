    ...
    <div className='p-5 bg-[#1c1c1c] mt-7 rounded'>
                <form className='flex w-full flex-wrap items-start justify-between'>
                    ...
                    <div className='w-2/5 flex flex-col items-start'>
                        ...
                        <textarea className='w-full h-44 text-sm py-2 px-4 rounded outline-none bg-transparent border-[1px] border-gray-400 text-white' name="" id="" cols="30" rows="10"></textarea>
